 ...
 */
public class HttpClientUserServiceIntegrationTest extends AbstractUserServiceIntegrationTest {
    public HttpClientUserServiceIntegrationTest() {
    ...
    private static AccountService<UserService> getAccountService(String account){
        return new AccountService<UserService>(
                CRestBuilderFactory.getBaseCRestBuilder(account).useHttpClientRestService().build().build(UserService.class),
