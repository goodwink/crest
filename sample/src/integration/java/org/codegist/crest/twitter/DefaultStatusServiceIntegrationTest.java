 ...
 */
public class DefaultStatusServiceIntegrationTest extends AbstractStatusServiceIntegrationTest {
    public DefaultStatusServiceIntegrationTest() {
    ...
    private static AccountService<StatusService> getAccountService(String account){
        return new AccountService<StatusService>(
                CRestBuilderFactory.getBaseCRestBuilder(account).build().build(StatusService.class),
