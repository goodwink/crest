 ...
 */
public class DefaultDirectMessageServiceIntegrationTest extends AbstractDirectMessageServiceIntegrationTest {
    public DefaultDirectMessageServiceIntegrationTest() {
    ...
    private static AccountService<DirectMessageService> getAccountService(String account){
        return new AccountService<DirectMessageService>(
                CRestBuilderFactory.getBaseCRestBuilder(account).build().build(DirectMessageService.class),
