...
public class PropertiesDrivenInterfaceFactory implements InterfaceConfigFactory {
    ...
    public InterfaceConfig newConfig(Class<?> interfaze, CRestContext context) throws ConfigFactoryException {
        try {
            ...
            ConfigBuilders.InterfaceConfigBuilder ricb = new ConfigBuilders.InterfaceConfigBuilder(interfaze, server, context != null ? context.getCustomProperties() : null).setIgnoreNullOrEmptyValues(true);
