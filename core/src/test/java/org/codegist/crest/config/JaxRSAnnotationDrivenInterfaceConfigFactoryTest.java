...
public class JaxRSAnnotationDrivenInterfaceConfigFactoryTest {
    ...
    public void testNonDefaultFactory1() throws ConfigFactoryException {
        ...
        InterfaceConfigTestHelper.assertExpected(getExpectedInterfaceConfig(true), cfg, Interface.class);
    }
    @Test
    public void testNonDefaultFactory2() throws ConfigFactoryException {
        ...
        InterfaceConfigTestHelper.assertExpected(getExpectedInterfaceConfig(false), cfg, Interface.class);
    }
    ...
    private static InterfaceConfig getExpectedInterfaceConfig(boolean def){
        return new ConfigBuilders.InterfaceConfigBuilder(Interface.class)
            .setContextPath("/my/path")
            .startMethodConfig(Interface.GET)
            .setHttpMethod("GET")
            .setPath("/sub/path")
            .startParamConfig(0)
            .setDestination(Destination.URL)
            .setName("s")
            .endParamConfig()
            .startParamConfig(1)
            .setDestination(Destination.BODY)
            .setName("i")
            .endParamConfig()
            .startParamConfig(2)
