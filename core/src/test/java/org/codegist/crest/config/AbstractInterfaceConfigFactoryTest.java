    ...
    static {
        try {
            FULLY_EXPECTED_CONFIG = new ConfigBuilders.InterfaceConfigBuilder(Interface.class, "http://localhost:8080")
                    .setContextPath("/my-path")
                    .addMethodsDefaultParam("body-param","gen-value1", Destination.BODY)
                    .addMethodsDefaultParam("url-param","gen-value2", Destination.URL)
                    .addMethodsDefaultParam("header-param","gen-value3", Destination.HEADER)
                    ...
                    .setPath("/m1")
                    .addDefaultParam("body-param","over-value1", Destination.BODY)
                    .addDefaultParam("body-param-2","new-value", Destination.BODY)
                    .setHttpMethod(PUT)
                    ...
                    .endMethodConfig()
                    .startMethodConfig(Interface.METH_m1S)
                    .addDefaultParam("body-param","over-value1", Destination.URL)
                    .setPath("/m1")
                    .setHttpMethod(POST)
                    .setSocketTimeout(5l)
