    ...
    static {
        try {
            FULLY_EXPECTED_CONFIG = new ConfigBuilders.InterfaceConfigBuilder(Interface.class, "http://localhost:8080")
                    .setContextPath("/my-path")
                    .addMethodsStaticParam("body-param", "gen-value1", Destination.BODY)
                    .addMethodsStaticParam("url-param", "gen-value2", Destination.URL)
                    .addMethodsStaticParam("header-param", "gen-value3", Destination.HEADER)
                    ...
                    .setPath("/m1")
                    .addStaticParam("body-param", "over-value1", Destination.BODY)
                    .addStaticParam("body-param-2", "new-value", Destination.BODY)
                    .setHttpMethod(PUT)
                    ...
                    .endMethodConfig()
                    .startMethodConfig(Interface.METH_m1S)
                    .addStaticParam("body-param", "over-value1", Destination.URL)
                    .setPath("/m1")
                    .setHttpMethod(POST)
                    .setSocketTimeout(5l)
